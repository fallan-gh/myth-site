...
import { ASSETS, toDataUrl } from '@/utils/assets';
          ...
          <div className="scifi-loader-ring">
            <svg viewBox="0 0 120 120" width="190" height="190" style={{ overflow: 'visible' }}>
              ...
              <circle cx="60" cy="4" r="3" fill="var(--gold)"
                style={{ transformOrigin: '60px 60px', animation: 'orbit-dot 1.6s linear infinite', filter: 'drop-shadow(0 0 4px var(--gold))' }}
              />
          ...
          {state === 'project' && (
            <motion.span
              ...
              style={{
                ...
                letterSpacing: '0.25em', color: '#000', fontWeight: 400,
              }}
            >
              VER
            </motion.span>
...
export default function Home() {
  ...
  const bg3dUrl = ASSETS.bg3d ? toDataUrl(ASSETS.bg3d) : '';
  const letterformUrl = ASSETS.letterform ? toDataUrl(ASSETS.letterform) : '';
  const logoUrl = ASSETS.logo ? toDataUrl(ASSETS.logo) : '';
    ...
    <>
      ...
      <nav>
        <a href="#hero" className="nav-logo" data-link>
          {logoUrl ? (
            <img src={logoUrl} alt="MYTH Agency" />
          ) : (
            <span className="nav-logo-fallback">MYTH</span>
          )}
        </a>
      ...
      <main ref={containerRef} className="relative w-full z-10">
        ...
        >
          ...
          <div
            ...
            style={bg3dUrl ? { backgroundImage: `url(${bg3dUrl})` } : {}}
          />
        ...
        <section id="portfolio" className="scroll-section portfolio-section">
          ...
          <h2 className="portfolio-heading" data-text="Port">
        ...
        <section id="contact" className="scroll-section contact-section">
          ...
          <div className="contact-footer">
            <span style={{ fontFamily: 'var(--mono)' }}>MYTH Agency © 2026</span>
